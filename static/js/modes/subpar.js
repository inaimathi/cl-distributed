(function() {
    ...
    CodeMirror.keyMap.subpar = {
        ...
        "Shift-Ctrl-Right"     : function(cm) {subpar.core.forward(cm)},
        "Shift-Ctrl-Left"     : function(cm) {subpar.core.backward(cm)},
        ...
        fallthrough: ["emacs", "basic"] // not sure if this is right
    };
